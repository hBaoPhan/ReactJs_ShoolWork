  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const newBook = {
        ...
        author: state.author,
        genre: state.genre,
        publishYear: state.publishYear ? parseInt(state.publishYear) : null,
      ...
      dispatch({ type: 'SET_ERROR', error: 'Có lỗi xảy ra khi thêm sách' })
    }
  }
    ...
    <div className="card">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          ...
          <input name="genre" value={state.genre} onChange={handleChange} />
        </div>

        <div className="form-group">
          <label>Năm xuất bản</label>
          <input type="number" name="publishYear" value={state.publishYear} onChange={handleChange} />
        </div>
